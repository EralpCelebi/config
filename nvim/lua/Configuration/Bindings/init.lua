...
local terminal = require("Configuration.Helpers.terminal")

set(mode.NORMAL, "<leader><leader>", terminal, { desc = "Open terminal." })
set(mode.TERMINAL, "<leader><leader>", [[<C-\><C-d>]], { desc = "Escape terminal." })

set(mode.NORMAL, "<leader>w", function()
	vim.cmd("Oil")
...
set(mode.NORMAL, "<leader>fn", function()
	vim.cmd("Telescope notify")
end, { desc = "Inspect 'nvim-notify' history. (telescope.nvim)" })
...
end, { desc = "Diagnostics (trouble.nvim)" })

set(mode.NORMAL, "<leader>x", function()
	vim.cmd("Trouble diagnostics toggle filter.buf=0")
end, { desc = "Buffer diagnostics (trouble.nvim)" })

set(mode.NORMAL, "<leader>F", format, { desc = "Format buffer. (conform.nvim)" })

set(mode.NORMAL, "<leader>l", function()
	vim.cmd("LlamaToggle")
end, { desc = "Toggle LLM. (llama.nvim)" })
